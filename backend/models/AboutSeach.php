...
/**
 * AboutSeach represents the model behind the search form of `common\models\About`.
 */
class AboutSeach extends About
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['content_uz', 'content_ru', 'content_en', 'pic1', 'pic2', 'pic3', 'pic4', 'pic5', 'video'], 'safe'],
        ];
    }
