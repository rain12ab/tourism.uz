    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value' => function($data){
                    return Html::a(Html::img(Url::toRoute('../'.$data->url),[
                        'style' => 'width:150px;'
                    ]), Yii::$app->homeUrl.'../'.$data->url, ['rel' => 'fancybox']);
                },
            ],
            [
                ...
                'buttons'=>[
                    'update'=>function ($url, $model) {
                        $customurl=Yii::$app->getUrlManager()->createUrl(['gallery/update','id'=> $model['id']]);
                    ...
                    'delete'=>function ($url, $model) {
                        $customurl=Yii::$app->getUrlManager()->createUrl(['gallery/delete','id'=> $model['id']]);
