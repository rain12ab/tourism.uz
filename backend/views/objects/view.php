        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Turistik obyekt haqida to'liq ma'lumot</h2>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label><?= $model->getAttributeLabel(popular);?></label>
                                    <p type="text" class="form-control"><?= $popular;?></p>
                                </div>
                                <div class="col-md-6">
...
<?php $this->registerJs('
document.getElementById("objects-img_file").onchange = function() {
