        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Ovqatlanish maskani haqida to'liq ma'lumot</h2>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div style="margin-top: 10px;" class="col-md-6">
                                    ...
                                    <label for="restaurants-img_file">
...
<?php $this->registerJs('
document.getElementById("restaurants-img_file").onchange = function() {
