...
$this->title = 'Ovqatlanish maskani turlari';
            ...
            [
                ...
                'buttons'=>[
                    'update'=>function ($url, $model) {
                        $customurl=Yii::$app->getUrlManager()->createUrl(['restype/update','id'=> $model['id']]);
                    ...
                    'delete'=>function ($url, $model) {
                        $customurl=Yii::$app->getUrlManager()->createUrl(['restype/delete','id'=> $model['id']]);
