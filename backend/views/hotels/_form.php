        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <?= $form->field($model, 'stars')->input('number') ?>
                        </div>
                        <div class="col-md-4">
                            <?= $form->field($model, 'hotel_type')->dropDownList(ArrayHelper::map(common\models\Hotels::getList(), 'id', 'name'), ['prompt' => 'Turini tanlang', 'style' => 'color: #e14eca;',]);?>
                        </div>
                        <div class="col-md-4">
